...
const Address = ["About","Careers","Affiliates"]
    ...
    <div className="bg-richblack-800">
        <div className="flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-14">
            <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
              {/* Section 1 */}
                <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
                    ...
                    <div className="w-[48%] lg:w-[30%] mb-7 lg:pl-0">
                      <h1 className="text-richblack-50 font-semibold text-[16px]">Resouses</h1>
              ...
              <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto text-sm pb-20">
                <div className="flex justify-between lg:items-center items-center flex-col lg:flex-row gap-3 w-full">
                      ...
                      BottomFooter.map((ele,i)=>{
                        return(
                          ...
                          className={`${
                            ...
                            <Link to={ele.split(" ").join("-").toLocaleLowerCase()}>{ele}
                            </Link>
                          </div>
                        )
                      })
                  ...
                  <div className="text-center">Made with ❤️ 1bunicorn © 2023 Studynotion</div>
                </div>
              </div>
