...
const VideoDetailsSidebar = ({ setReviewModal }) => {
  ...
  return (
    <>
      <div className=" flex h-[calc(100vh-3.5rem)] max-w-[350px] flex-col border-r-[1px] border-r-richblack-700 bg-richblack-800">
        ...
        <div className="h-[calc(100vh-5rem)] overflow-y-auto">
          {
            courseSectionData.map((course,index)=>(
              ...
              key={index}
               className="mt-2 cursor-pointer text-richblack-5 text-sm">
