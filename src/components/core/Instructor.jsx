  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <div>
          <div className=" my-4 flex flex-col md:flex-row h-[450px] space-x-4 gap-y-5">
          ...
          <div className="hidden md:flex md:flex-col rounded-md bg-richblack-800 p-6">
            {/* Render 3 courses */}
        ...
        <div className="mt-20 rounde~d-md bg-richblack-800 p-6 py-20">
